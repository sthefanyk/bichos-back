...
describe("Test EntityProps", () => {
    ...
    class StubEntityProps2 extends EntityProps {
        constructor(public name: string, id?: string, a?: Date, b?: Date, c?: Date){
            super(id, a, b, c);
        }
    }
    ...
    test("Create props with params", () => {
        ...
        const props  = new StubEntityProps("bd2c0d5e-2f3d-4645-b0cd-01638b466e92", created_at, updated_at, deleted_at);
    ...
    test("Create props with params", () => {
        ...
        const props  = new StubEntityProps2("name", "bd2c0d5e-2f3d-4645-b0cd-01638b466e92", created_at, updated_at, deleted_at);
