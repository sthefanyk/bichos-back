...
describe('AuthService Test', () => {
  ...
  test('token', async () => {
    ...
    const data = service.checkTokenUser(
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoicmVnaXN0ZXIiLCJlbWFpbCI6InJlZ2lzdGVyQGV4YW1wbGUuY29tIiwiaWF0IjoxNjk0OTAyNjQ1LCJleHAiOjE2OTU1MDc0NDUsImF1ZCI6InVzZXJzIiwiaXNzIjoiQVBJIEJpY2hvcyIsInN1YiI6ImJlMjNmMjI1LTRkZTMtNGRkMS04NTIxLTNlMWYzNWJhOTBjNCJ9.yki_I0zHf2IHGNynPMIIjKNCC6PVJJBPEe1ZN9TZwwE',
    );
